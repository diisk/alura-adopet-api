...
import br.com.alura.adopet.api.validation.SolicitarAdocaoValidator;
...
public class AdocaoService {
        ...
        @Autowired
        private List<SolicitarAdocaoValidator> solicitarAdocaoValidators;

        public void solicitar(SolicitacaoAdocaoDto dto) {
                Pet pet = petRepository.getReferenceById(dto.idPet());
                Tutor tutor = tutorRepository.getReferenceById(dto.idTutor());

                solicitarAdocaoValidators.forEach(validator -> validator.validate(dto));
